...
# RA: 22103581
# Programa 2: Analisador léxico simples
...
class Lexer:
    def __init__(self):
        ...
        for palavra in self.palavras_chave:
            self.tabela_simbolos[
                palavra] = "KEYWORD"  # Designa as palvras chaves que são inseridadas dentro da tabela de símbolos
    ...
    # Função para analisar os tokens recebidos e esécificá-los
    def analise(self, code):
        ...
        token_specification = [
            ...
            ('ASSIGN', r'='),  # Operador ou atribuição
            ('END', r';'),  # Término de programa
            ('ID', r'[A-Za-z_]\W*'),  # Identificadores
            ('OP', r'[+\-*/]'),  # Operadores aritiméticos
            ('REL_OP', r'[<>!=]=?|=='),  # Operadores relacionais
            ('SKIP', r'[ \t]+'),  # Pular espaços e tabs
            ('MISMATCH', r'.'),  # Qualquer outro caracter
        ]

        # Irá será separar os pares durante a especificação dos tokens
